...
import 'package:shop_app_vendor/firebase_service.dart';
...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  _saveToDB() {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      _services.uploadImage(_shopImage, 'vendors').then((String? url) {
        if (url != null) {
          setState(() {
            _shopImageUrl = url;
          });
        ...
        _services.uploadImage(_logo, 'vendors').then((url) {
          setState(() {
            _logoUrl = url;
          });
        }).then((value) {
